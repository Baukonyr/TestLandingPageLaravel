...
{!! Form::open(['url'=>route('servicesAdd'), 'class'=>'form-horizontal', 'nethod'=>'post', 'enctype'=>'multipart/form-data']) !!}
  ...
  <div class="form-group">
    {!! Form::label('text', 'Текст:', ['class'=>'col-xs-2 control-label']) !!}
      ...
      <div class="col-xs-8">
        {!! Form::textarea('filter', old('text'), ['id'=>'editor', 'class'=>'form-control', 'placeholder'=>'Введите текст сервиса']) !!}
      </div>
