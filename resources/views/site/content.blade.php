          ...
          <div class="inner_wrapper">
            ...
            <h2>{{$page->name}}</h2>
              <div class="inner_section">
                <div class="row">
                  <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"> {!! Html::image('assets/img/'.$page->images) !!} </div>
            ...
            @endif
              ...
              <div class="col-lg-4 {{ ($k%3 > 0)? 'borderLeft' : '' }} {{($k > 2)? 'mrgTop' : ''}}">
                <div class="service_block">
                  ...
                  <p class="animated fadeInDown wow">{{$service->name}}</p>
                </div>
              </div>
              @if(($k+1)%3 == 0)
                </div>
    ...
    <section class="page_section contact" id="contact">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 wow fadeInLeft delay-06s">
          ...
          <form action="{{ Route('getMail') }}" method="POST">
